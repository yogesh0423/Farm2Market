...
const FarmerContactModal = ({
  ...
  return (
    ...
    >
      <div
        className={`
          w-full max-w-md h-[min(620px,85vh)]
          rounded-3xl border shadow-2xl overflow-hidden
          flex flex-col ${styles.modal}
        `}
      >
        {/* HEADER */}
        ...
        <form onSubmit={handleSend} className={`p-4 border-t ${styles.header}`}>
          <div className="flex items-center gap-2">
            <input
              ...
              className={`
                flex-1 min-w-0 px-4 py-3 rounded-xl border
                outline-none text-xs focus:ring-2 focus:ring-emerald-500/20
                ${styles.input}
              `}
            />
            ...
            <button
              ...
              className="
                ...
                text-slate-950 flex items-center justify-center transition
              "
